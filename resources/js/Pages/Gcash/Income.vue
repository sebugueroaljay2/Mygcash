...
const fetchCounts = async () => {
    try {
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/daily-transaction-count`)
...
const fetchIncomeStats = async () => {
    ...
    try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/income/income`) // Or a custom route if needed
    ...
    <NewLayout>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 pt-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 my-4 pt-8">
                <div
                    class="p-5 bg-white shadow rounded text-center transform hover:translate-y-1 transition-transform ease-in duration-200">
